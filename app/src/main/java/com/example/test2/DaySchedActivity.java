...
public class DaySchedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String codename = getIntent().getStringExtra("name");
        ...
        .addOnSuccessListener(documentSnapshot -> {
            ...
            fetchScheduleData(gradeLevel, section, day);
        }
    ...
    private void fetchScheduleData(String gradeLevel, String section, String day) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
    ...
    private void teacherSched(String codename, String day, String sem) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
