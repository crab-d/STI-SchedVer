                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (document != null && document.exists()) {
                            ...
                            String gradeLevel = document.getString("gradeLevel");
                            String enrollment_status = document.getString("status");
                                
                            firestore.collection("term").document("semester").get()
                                .addOnSuccessListener(t -> {
                                    String sem = t.getString("sem");
                                    if(sem.equalsIgnoreCase("sem2")) {
                                       section = document.getString("section1");
                            ...
                            intent.putExtra("gender", gender);
                                ...
                                intent.putExtra("status", enrollment_status);
                            startActivity(intent);
                                    } else {
                            ...
                            Toast.makeText(ScannerActivity.this, "Invalid student qr or doesn't exist in database.", Toast.LENGTH_SHORT).show();
                        }
                    } else {
